      ...
      <Section className="!pt-0 !pb-0">
        <Container>
          ...
          <Box className="max-w-2xl mb-4">
            <Text mb={"4"}>
              Invo.dev is a minimal pdf invoice generation tool. It's designed
              to be simple and easy to use, so you can focus on what you do. It
              was born out of a personal need to generate PDF invoices without
              the overhead of a full billing solution.
              <br />
              <br />
              You can make feature suggestions my emailing us and if you
              encounter any bugs, please send an email to{" "}
              <Link href="mailto:support@invo.dev">support@invo.dev</Link>.
            </Text>
            <h2 className="text-2xl mt-10 mb-4">Getting Started</h2>
            <Text>
              To get started, simply navigate to{" "}
              <Link href="/new">invo.dev/new</Link> where you will see a form
              fill. Proceed to enter as many fields as you find necessary, and
              then click the "Generate invoice" button. After just a few
              seconds, a download should automatically start.
            </Text>
